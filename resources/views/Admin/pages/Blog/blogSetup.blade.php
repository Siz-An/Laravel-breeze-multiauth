...
<div class="flex justify-end mb-4">
    <a href="{{ route('admin.blogSetup.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 transition duration-200">+ ADD NEW BLOG</a>
</div>
    ...
    <table class="min-w-full bg-white">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="py-2 px-4 border-b">
                    <!-- Edit Button -->
                    <a href="{{ route('admin.blogSetup.edit', $blog->id) }}" class="text-blue-500 hover:text-blue-700">Edit</a>

                    <!-- Delete Button -->
                    <form action="{{ route('admin.blogSetup.destroy', $blog->id) }}" method="POST" class="inline-block">
                        @csrf
                        @method('DELETE')
