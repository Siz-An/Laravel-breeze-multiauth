<x-admin-app-layout>
    ...
    <div x-data :class="$store.sidebar.isCollapsed ? 'ml-20' : 'ml-10'" class=" transition-all duration-300">
      

        <h2 class="font-bold text-3xl  text-gray-800 pt-3 dark:text-gray-900 leading-tight">
            {{ __("Admin Dashboard") }}
        </h2>
